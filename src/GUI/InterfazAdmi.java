...
//----------------------------------------------------------------------------------------------------------------------
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					InterfazAdmi pp = new InterfazAdmi();
					pp.setVisible(true);
...
//-------------- JFRAM---------------------
	public InterfazAdmi() {
		...
		panelAgregar.setBackground(new Color(255, 128, 64));
		...
		panelAgg.setBackground(new Color(255, 128, 64));
		...
		textField.setBounds(271, 13, 117, 28);
		panelEditar.add(textField);
		textField.setColumns(10);
		
		textField_3 = new JTextField();
		textField_3.setBounds(271, 95, 117, 28);
		panelEditar.add(textField_3);
		textField_3.setColumns(10);
		
		textField_4 = new JTextField();
		textField_4.setBounds(271, 157, 117, 29);
		panelEditar.add(textField_4);
		textField_4.setColumns(10);
		
		JLabel lblNewLabel = new JLabel("Nombre");
		lblNewLabel.setFont(new Font("Tahoma", Font.BOLD, 16));
		lblNewLabel.setBounds(151, 10, 77, 28);
		panelEditar.add(lblNewLabel);
		
		JLabel lblCorreo = new JLabel("Correo");
		lblCorreo.setFont(new Font("Tahoma", Font.BOLD, 16));
		lblCorreo.setBounds(151, 92, 77, 28);
		panelEditar.add(lblCorreo);
		
		JLabel lblNewLabel_2_1 = new JLabel("Contraseña");
		lblNewLabel_2_1.setFont(new Font("Tahoma", Font.BOLD, 16));
		lblNewLabel_2_1.setBounds(151, 157, 117, 28);
		panelEditar.add(lblNewLabel_2_1);
		
		Panel panel = new Panel();
		panel.setBackground(new Color(255, 128, 64));
		panel.setBounds(419, 13, 338, 173);
		panelEditar.add(panel);
		panel.setLayout(null);
		
		textField_5 = new JTextField();
		textField_5.setBounds(89, 57, 152, 29);
		panel.add(textField_5);
		textField_5.setColumns(10);
		
		JLabel lblNivelDeAcsiso = new JLabel("Nivel de  Acceso");
		lblNivelDeAcsiso.setFont(new Font("Tahoma", Font.BOLD, 16));
		lblNivelDeAcsiso.setBounds(89, 10, 156, 28);
		panel.add(lblNivelDeAcsiso);
